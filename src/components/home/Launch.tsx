      ...
      <div className='row__flex container'>
        <div className='col__2 launch__col--left'>
          ...
          <div className='text__body'>
            <p>
              I&apos;m a freelance Fullstack TypeScript engineer specializing in web and mobile application development.
              With 4 years of experience, I focus on building scalable, high-performance applications using modern
              technologies like React, Next.js, and NestJS.
            </p>
            <p>
              Throughout my career, I have worked on diverse projects, from SaaS platforms to fintech applications,
              always applying best practices in software architecture, security, and optimization. Passionate about
              continuous learning, I stay up-to-date with the latest advancements to deliver innovative and efficient
              solutions.
            </p>
            <p>
              This website showcases my experience, key skills, and selected projects. Feel free to explore and reach
              out for potential collaborations.
            </p>
          </div>
